...
var str_cate_7 = '维护';
var str_tips = '提示，中文字符不能超过八个字符！';
var str_forbidden = '提示，输入有非法字符，请重新输入！';
...
var str_wps_1 = "禁用";
var str_ddns_service_list_new="<option value=0>无</option><option value=2>DynDns.org(dyndns)</option><option value=8>3322.org(dyndns)</option><option value=10>9299.org</option>"; 
...
var str_port_range="端口范围 (1~65534)";
...
var str_disk_1="格式化";
var str_disk_2="正在录像中...";
var str_ap_channel="通道";
var str_port_range_1="端口范围 (1~65534)";
var str_rec_sch_time="录像时长(分钟)";
var str_rec_sch_time_1="录像时长范围5~120分钟";
var str_sd_sdtotal="sd卡总容量(M)";
var str_sd_sdfree="sd卡剩余容量(M)";
var str_url_record_file="SD卡录像在线回放";
var str_externwifi="连接外部wifi状态";
var str_externwifi_ok="连接外部wifi成功";
var str_externwifi_error="连接外部wifi失败";
var str_interval_range_2="上传时长范围0~255秒";
...
var str_mode_serverpush='RTSP流模式(适用于 FireFox、Google 浏览器)';
...
var str_format_tip='格式化操作将丢失所有录像数据，确认格式化SD卡吗？';
