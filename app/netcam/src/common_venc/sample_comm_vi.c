...
//add sensor
#if 0
static combo_dev_attr_t g_mipi_2lane_chn0_sensor_gc4653_10bit_2m_nowdr_attr = {
	.devno = 0;
	 .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
...
static td_void sample_comm_vi_get_mipi_attr(sample_sns_type sns_type, combo_dev_attr_t *combo_attr)
{
    ...
    switch (sns_type) {
	 ...
	 (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_2lane_chn0_sensor_gc4653_10bit_4m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
#endif
	case SC850SL_8M30:
	    (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
