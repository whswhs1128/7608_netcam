...
{
    //netcam_audio_out(HINT_SUCCESS);
    printf("audio_speaker\n");		//xqq
}
...
int Gk_CmsTestCmd(int sock)
{
    ...
    {
        //sdk_isp_indicator_led_set(sdk_cfg.gpio_red_led, 1);	xqq
