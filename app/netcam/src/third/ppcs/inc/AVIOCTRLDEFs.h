...
typedef enum
{
	...
	//IOTYPE_USER_IPCAM_PUSH_REQ                  = 0x802,
	//IOTYPE_USER_IPCAM_PUSH_RESP                 = 0x803,
	...
	IOTYPE_USER_IPCAM_GET_SYSPARAM_REQ			= 0x810,	// 获取系统参数请求消息
	IOTYPE_USER_IPCAM_GET_SYSPARAM_RESP		= 0x811,	// 获取系统参数应答消息
...
}SMsgAVIoctrlGetMDPReq,SMsgAVIoctrlSetMDPResp,SMsgAVIoctrlSetPushResp
	,SMsgAVIoctrlDelPushResp,SMsgAVIoctrlAlarmingResp,SMsgAVIoctrlGetSysparamReq;
...
IOTYPE_USER_IPCAM_DOOROPEN_REQ	= 0x800,
IOTYPE_USER_IPCAM_DOOROPEN_RESP	= 0x801,
** @struct SMsgAVIoctrlDoorOpenResp
*/
typedef struct
{
	int result;	// 0: success; otherwise: failed.
	unsigned char reserved[4];
}SMsgAVIoctrlDoorOpenReq, SMsgAVIoctrlDoorOpenResp;

/*
IOTYPE_USER_IPCAM_PUSH_REQ                  = 0x802,
** @struct SMsgAVIoctrlPushReq
*/
typedef struct
{
	char				User[32];
...
/*
IOTYPE_USER_IPCAM_PUSH_RESP                 = 0x803,
** @struct SMsgAVIoctrlPushResp
*/
typedef struct
{
	int result; // 0: success; otherwise: failed.
	unsigned char reserved[4];
}SMsgAVIoctrlPushResp;
