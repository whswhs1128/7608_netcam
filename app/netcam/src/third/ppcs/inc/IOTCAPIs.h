...
typedef void (__stdcall *logCB)(char *msg);


P2PAPI_API void IOTC_Set_log_ByCallBackFn(logCB pfxLogcbFn);
/* ============================================================================
 ...
 */
P2PAPI_API int IOTC_Initialize2(unsigned short nUDPPort,char *DefaultInitString);
