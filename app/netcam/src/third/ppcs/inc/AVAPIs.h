...
typedef void (_stdcall *avlogCB)(char *msg);

AVAPI_API void avSetlogByCallBackFn(avlogCB pfxavLogcbFn);
...
AVAPI_API void avServStopEx(int nAVChannelID);
/**
...
AVAPI_API void avClientStopEx(int nAVChannelID);
...
AVAPI_API void avStartRecvAudio(int nAVChannelID);
AVAPI_API void avStartRecvVideo(int nAVChannelID);
