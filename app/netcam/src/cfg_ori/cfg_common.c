...
static void CfgPrintItem(GK_CFG_MAP *map)
{
    switch (map->dataType) {
        case GK_CFG_DATA_TYPE_U32:
            printf("%s : %u 0x%x\n", map->stringName, *((unsigned int *)(map->dataAddress)), map->dataAddress);
            break;
        case GK_CFG_DATA_TYPE_U16:
            printf("%s : %u 0x%x\n", map->stringName, *((unsigned short *)(map->dataAddress)), map->dataAddress);
            break;
        case GK_CFG_DATA_TYPE_U8:
            printf("%s : %u 0x%x\n", map->stringName, *((unsigned char *)(map->dataAddress)), map->dataAddress);
            break;
        case GK_CFG_DATA_TYPE_S32:
            printf("%s : %d 0x%x\n", map->stringName, *((signed int *)(map->dataAddress)), map->dataAddress);
            break;
        case GK_CFG_DATA_TYPE_S16:
            printf("%s : %d 0x%x\n", map->stringName, *((signed short *)(map->dataAddress)), map->dataAddress);
            break;
        case GK_CFG_DATA_TYPE_S8:
            printf("%s : %d 0x%x\n", map->stringName, *((signed char *)(map->dataAddress)), map->dataAddress);
            break;
		case GK_CFG_DATA_TYPE_FLOAT:
			printf("%s : %f 0x%x\n", map->stringName, *(( float *)(map->dataAddress)), map->dataAddress);
            break;

        case GK_CFG_DATA_TYPE_STRING:
            printf("%s : %s 0x%x\n", map->stringName, (char *)(map->dataAddress), map->dataAddress);
            break;
