...
GK_CFG_MAP storeMap[] = {
#if 0
    {"enable",       &runStoreCfg.enable,       GK_CFG_DATA_TYPE_S32,   "0",   "rw", 0, 1,   NULL},
    {"timeZone",     &runStoreCfg.timezone,     GK_CFG_DATA_TYPE_S32,   "480", "rw", -720, 720,  NULL},
    {"languageType", &runStoreCfg.languageType, GK_CFG_DATA_TYPE_S32,   "0",   "rw", 0, 100,   NULL},
#endif
