...
GK_CFG_MAP recordMap[] = {
	{"sdCardFormatFlag", &runRecordCfg.sdCardFormatFlag,	  GK_CFG_DATA_TYPE_S32,   "1",   "rw", 0, 1,	NULL},
    {"enable",           &runRecordCfg.enable,                GK_CFG_DATA_TYPE_S32,   "1",   "rw", 0, 1,   NULL},
    {"stream_no",        &runRecordCfg.stream_no,             GK_CFG_DATA_TYPE_S32,   "0",   "rw", 0, 3,   "0-3"},
    {"recordMode",       &runRecordCfg.recordMode,            GK_CFG_DATA_TYPE_S32,   "3",   "rw", 0, 3,   NULL},
    {"scheduleTime",     &(runRecordCfg.scheduleTime[0][0]),  GK_CFG_DATA_TYPE_STIME, "0",   "rw", 0, 0,  NULL},
    {"scheduleSlice",    &(runRecordCfg.scheduleSlice[0][0]), GK_CFG_DATA_TYPE_SLICE, "4294967295", "rw", 0, 0, NULL},

    {"preRecordTime",  &runRecordCfg.preRecordTime,        GK_CFG_DATA_TYPE_S32,   "2",   "rw", 0, 10,  NULL},
    {"audioRecEnable", &runRecordCfg.audioRecEnable,       GK_CFG_DATA_TYPE_S32,   "1",   "rw", 0, 1,   NULL},
    {"recAudioType",   &runRecordCfg.recAudioType,         GK_CFG_DATA_TYPE_S32,   "2",   "rw", 0, 3,   NULL},
    {"recordLen",      &runRecordCfg.recordLen,            GK_CFG_DATA_TYPE_S32,   "5",  "rw", 1, 1440, NULL},
    {"recycleRecord",  &runRecordCfg.recycleRecord,        GK_CFG_DATA_TYPE_S32,   "1",   "rw", 0, 1,   NULL},
    {"mojingRec0",              &(runRecordCfg.mojingRecTime[0]),            GK_CFG_DATA_TYPE_STRING,   "0:0-23:59", "rw", 1, 256, NULL},
    {"mojingRec1",              &(runRecordCfg.mojingRecTime[1]),            GK_CFG_DATA_TYPE_STRING,   "0:0-23:59", "rw", 1, 256, NULL},
    {"mojingRec2",              &(runRecordCfg.mojingRecTime[2]),            GK_CFG_DATA_TYPE_STRING,   "0:0-23:59", "rw", 1, 256, NULL},
    {"mojingRec3",              &(runRecordCfg.mojingRecTime[3]),            GK_CFG_DATA_TYPE_STRING,   "0:0-23:59", "rw", 1, 256, NULL},
    {"mojingRec4",              &(runRecordCfg.mojingRecTime[4]),            GK_CFG_DATA_TYPE_STRING,   "0:0-23:59", "rw", 1, 256, NULL},
    {"mojingRec5",              &(runRecordCfg.mojingRecTime[5]),            GK_CFG_DATA_TYPE_STRING,   "0:0-23:59", "rw", 1, 256, NULL},
    {"mojingRec6",              &(runRecordCfg.mojingRecTime[6]),            GK_CFG_DATA_TYPE_STRING,   "0:0-23:59", "rw", 1, 256, NULL},
    {NULL,},
};
