...
GK_CFG_MAP ptzMap[] = {
    {"id",           &runPtzCfg.id,           GK_CFG_DATA_TYPE_S32, "1", "rw", 0, 10, NULL},
    {"serialPortID", &runPtzCfg.serialPortID, GK_CFG_DATA_TYPE_S32, "2", "rw", 0, 10, NULL},
    {"videoInputID", &runPtzCfg.videoInputID, GK_CFG_DATA_TYPE_S32, "1", "rw", 0, 10, NULL},
    {"duplexMode",   &runPtzCfg.duplexMode,   GK_CFG_DATA_TYPE_S32, "0", "rw", 0, 1,  "0-half, 1-full"},
    {"controlType",  &runPtzCfg.controlType,  GK_CFG_DATA_TYPE_S32, "1", "rw", 0, 1,  "0- controlType, 1- external"},
    {"protocol",     &runPtzCfg.protocol,     GK_CFG_DATA_TYPE_S32, "0", "rw", 0, 10, "0 pelco-d, 1 pelco-p"},
    {"address",      &runPtzCfg.address,      GK_CFG_DATA_TYPE_S32, "1", "rw", 0, 10, NULL},

    {"channel",        &runPtzDecCfg.channel,        GK_CFG_DATA_TYPE_S32,    "0",    "rw",  0, 255,  NULL},
    {"baudRate",       &runPtzDecCfg.baudRate,       GK_CFG_DATA_TYPE_S32, "1200",    "rw", 600, 115200, NULL},
    {"dataBit",        &runPtzDecCfg.dataBit,        GK_CFG_DATA_TYPE_U8,     "3",    "rw",  0,   3,  NULL},
    {"stopBit",        &runPtzDecCfg.stopBit,        GK_CFG_DATA_TYPE_U8,     "0",    "rw",  0,   2,  NULL},
    {"parity",         &runPtzDecCfg.parity,         GK_CFG_DATA_TYPE_U8,     "0",    "rw",  0,   2,  NULL},
    {"flowcontrol",    &runPtzDecCfg.flowcontrol,    GK_CFG_DATA_TYPE_U8,     "0",    "rw",  0,   2,  NULL},
    {"workMode",       &runPtzDecCfg.workMode,       GK_CFG_DATA_TYPE_S32,    "2",    "rw",  0,   2,  NULL},
    {"decoderAddress", &runPtzDecCfg.decoderAddress, GK_CFG_DATA_TYPE_U16,    "0",    "rw",  0, 255,  NULL},
    {"speedH",         &runPtzDecCfg.speedH,         GK_CFG_DATA_TYPE_U16,    "2",    "rw",  0,  64,  NULL},
    {"speedV",         &runPtzDecCfg.speedV,         GK_CFG_DATA_TYPE_U16,    "2",    "rw",  0,  64,  NULL},
    {"watchPos",       &runPtzDecCfg.watchPos,       GK_CFG_DATA_TYPE_U16,    "0",    "rw",  0, 255,  NULL},
    {"decoderType",    &runPtzDecCfg.decoderType,    GK_CFG_DATA_TYPE_STRING, "pelco-d",  "rw",  1, MAX_STR_LEN_32,  NULL},
