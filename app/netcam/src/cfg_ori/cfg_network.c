...
GK_CFG_MAP lanMap[] = {
    {"enable",   &(runNetworkCfg.lan.enable),     GK_CFG_DATA_TYPE_S32,    "1",                 "rw", 0, 1,             NULL},
    {"netName",   &(runNetworkCfg.lan.netName),   GK_CFG_DATA_TYPE_STRING, "eth0",              "rw", 1, MAX_STR_LEN_64, NULL},
    {"ipVersion", &(runNetworkCfg.lan.ipVersion), GK_CFG_DATA_TYPE_S32,    "0",                 "rw", 0, 1,              "0 v4, 1 v6"},
    {"mac",       &(runNetworkCfg.lan.mac),       GK_CFG_DATA_TYPE_STRING, "28:E3:83:F6:40:12", "rw", 1, MAX_STR_LEN_20, NULL},
    {"dhcpEnable",    &(runNetworkCfg.lan.dhcpIp),    GK_CFG_DATA_TYPE_S32, "1",                "rw", 0, 1,              NULL},
    {"upnpEnable",&(runNetworkCfg.lan.upnpEnable),GK_CFG_DATA_TYPE_S32,    "0",                 "rw", 0, 1,              NULL},
    {"ip",        &(runNetworkCfg.lan.ip),        GK_CFG_DATA_TYPE_STRING, "192.168.10.25",     "rw", 1, MAX_STR_LEN_16, NULL},
    {"netmask",   &(runNetworkCfg.lan.netmask),   GK_CFG_DATA_TYPE_STRING, "255.255.255.0",     "rw", 1, MAX_STR_LEN_16, NULL},
    {"gateway",   &(runNetworkCfg.lan.gateway),   GK_CFG_DATA_TYPE_STRING, "192.168.10.1",      "rw", 1, MAX_STR_LEN_16, NULL},
    {"multicast", &(runNetworkCfg.lan.multicast), GK_CFG_DATA_TYPE_STRING, "192.168.10.255",    "rw", 1, MAX_STR_LEN_16, NULL},
    {"dhcpDns",   &(runNetworkCfg.lan.dhcpDns),   GK_CFG_DATA_TYPE_S32,    "1",                 "rw", 0, 1,              NULL},
    {"dns1",      &(runNetworkCfg.lan.dns1),      GK_CFG_DATA_TYPE_STRING, "114.114.114.114",   "rw", 1, MAX_STR_LEN_16, NULL},
    {"dns2",      &(runNetworkCfg.lan.dns2),      GK_CFG_DATA_TYPE_STRING, "8.8.8.8",           "rw", 1, MAX_STR_LEN_16, NULL},
    {NULL,},
};

GK_CFG_MAP wifiMap[] = {
    {"enable",    &(runNetworkCfg.wifi.enable),     GK_CFG_DATA_TYPE_S32,     "1",                "rw", 0, 1,             NULL},
    {"netName",   &(runNetworkCfg.wifi.netName),   GK_CFG_DATA_TYPE_STRING, "wlan0",               "rw", 1, MAX_STR_LEN_64, NULL},
    {"ipVersion", &(runNetworkCfg.wifi.ipVersion), GK_CFG_DATA_TYPE_S32,    "0",                 "rw", 0, 1,              "0 v4, 1 v6"},
    {"mac",       &(runNetworkCfg.wifi.mac),       GK_CFG_DATA_TYPE_STRING, "28:E3:83:F6:40:13", "rw", 1, MAX_STR_LEN_20, NULL},
    {"dhcpEnable",&(runNetworkCfg.wifi.dhcpIp),GK_CFG_DATA_TYPE_S32,    	"1",                 "rw", 0, 1,              NULL},
    {"upnpEnable",&(runNetworkCfg.wifi.upnpEnable),GK_CFG_DATA_TYPE_S32,    "0",                 "rw", 0, 1,              NULL},
    {"ip",        &(runNetworkCfg.wifi.ip),        GK_CFG_DATA_TYPE_STRING, "192.168.10.26",     "rw", 1, MAX_STR_LEN_16, NULL},
    {"netmask",   &(runNetworkCfg.wifi.netmask),   GK_CFG_DATA_TYPE_STRING, "255.255.255.0",     "rw", 1, MAX_STR_LEN_16, NULL},
    {"gateway",   &(runNetworkCfg.wifi.gateway),   GK_CFG_DATA_TYPE_STRING, "192.168.10.1",      "rw", 1, MAX_STR_LEN_16, NULL},
    {"multicast", &(runNetworkCfg.wifi.multicast), GK_CFG_DATA_TYPE_STRING, "5.255.255.255",    "rw", 1, MAX_STR_LEN_16, NULL},
    {"dhcpDns",   &(runNetworkCfg.wifi.dhcpDns),   GK_CFG_DATA_TYPE_S32,    "1",                 "rw", 0, 1,              NULL},
    {"dns1",      &(runNetworkCfg.wifi.dns1),      GK_CFG_DATA_TYPE_STRING, "114.114.114.114",   "rw", 1, MAX_STR_LEN_16, NULL},
    {"dns2",      &(runNetworkCfg.wifi.dns2),      GK_CFG_DATA_TYPE_STRING, "8.8.8.8",           "rw", 1, MAX_STR_LEN_16, NULL},
    {NULL,},
};

GK_CFG_MAP emailMap[] = {
    {"enable",    	 &(runNetworkCfg.email.enableEmail),    GK_CFG_DATA_TYPE_S32,     "1",                "rw", 0, 1,      NULL},
	{"attachPicture",&(runNetworkCfg.email.attachPicture),	GK_CFG_DATA_TYPE_S32,	  "1",				  "rw", 0, 1,	   NULL},
    {"smtpServer",   &(runNetworkCfg.email.smtpServer),     GK_CFG_DATA_TYPE_STRING,  "", 	   "rw", 1, MAX_STR_LEN_64, NULL},
	{"smtpPort",	 &(runNetworkCfg.email.smtpPort), 		GK_CFG_DATA_TYPE_S32,	  "25",    "rw", 1, 65535, NULL},
	{"pop3Server",	 &(runNetworkCfg.email.pop3Server), 	GK_CFG_DATA_TYPE_STRING,  "", 	   "rw", 1, MAX_STR_LEN_64, NULL},
	{"pop3Port",	 &(runNetworkCfg.email.pop3Port),		GK_CFG_DATA_TYPE_S32,	  "110",   "rw", 1, 65535, NULL},
    {"cryptionType", &(runNetworkCfg.email.encryptionType), GK_CFG_DATA_TYPE_S32,     "0",                "rw",  0, 2,	   NULL},
    {"user",       	 &(runNetworkCfg.email.eMailUser),      GK_CFG_DATA_TYPE_STRING,  "", 	   "rw", 1, MAX_STR_LEN_64,    NULL},
    {"password",	 &(runNetworkCfg.email.eMailPass),		GK_CFG_DATA_TYPE_STRING,  "", 	   "rw", 1, MAX_STR_LEN_64,	   NULL},
	{"fromAddrList", &(runNetworkCfg.email.fromAddr),		GK_CFG_DATA_TYPE_STRING,  "", 	   "rw", 1, MAX_STR_LEN_64,    NULL},

	{"toAddrList0", &(runNetworkCfg.email.toAddrList0),		GK_CFG_DATA_TYPE_STRING,  "", 	   "rw", 1, MAX_STR_LEN_64,    NULL},
	{"toAddrList1", &(runNetworkCfg.email.toAddrList1), 	GK_CFG_DATA_TYPE_STRING,  "",	   "rw", 1, MAX_STR_LEN_64,    NULL},
	{"toAddrList2", &(runNetworkCfg.email.toAddrList2), 	GK_CFG_DATA_TYPE_STRING,  "",	   "rw", 1, MAX_STR_LEN_64,    NULL},
	{"toAddrList3", &(runNetworkCfg.email.toAddrList3), 	GK_CFG_DATA_TYPE_STRING,  "",	   "rw", 1, MAX_STR_LEN_64,    NULL},
	{"ccAddrList0", &(runNetworkCfg.email.ccAddrList0), 	GK_CFG_DATA_TYPE_STRING,  "",	   "rw", 1, MAX_STR_LEN_64,    NULL},
	{"ccAddrList1", &(runNetworkCfg.email.ccAddrList1), 	GK_CFG_DATA_TYPE_STRING,  "",	   "rw", 1, MAX_STR_LEN_64,    NULL},
	{"ccAddrList2", &(runNetworkCfg.email.ccAddrList2), 	GK_CFG_DATA_TYPE_STRING,  "",	   "rw", 1, MAX_STR_LEN_64,    NULL},
	{"ccAddrList3", &(runNetworkCfg.email.ccAddrList3), 	GK_CFG_DATA_TYPE_STRING,  "",	   "rw", 1, MAX_STR_LEN_64,    NULL},
	{"bccAddrList0",&(runNetworkCfg.email.bccAddrList0), 	GK_CFG_DATA_TYPE_STRING,  "",	   "rw", 1, MAX_STR_LEN_64,    NULL},
	{"bccAddrList1",&(runNetworkCfg.email.bccAddrList1), 	GK_CFG_DATA_TYPE_STRING,  "",	   "rw", 1, MAX_STR_LEN_64,    NULL},
	{"bccAddrList2",&(runNetworkCfg.email.bccAddrList2), 	GK_CFG_DATA_TYPE_STRING,  "",	   "rw", 1, MAX_STR_LEN_64,    NULL},
	{"bccAddrList3",&(runNetworkCfg.email.bccAddrList3), 	GK_CFG_DATA_TYPE_STRING,  "",	   "rw", 1, MAX_STR_LEN_64,    NULL},
    {NULL,},
};

GK_CFG_MAP ftpMap[] = {
    {"enableFTP", &(runNetworkCfg.ftp.enableFTP), GK_CFG_DATA_TYPE_S32,     "0",       "rw", 0, 1,               NULL},
    {"address",   &(runNetworkCfg.ftp.address),   GK_CFG_DATA_TYPE_STRING,  "",  "rw", 1, MAX_STR_LEN_128, NULL},
    {"port",      &(runNetworkCfg.ftp.port),      GK_CFG_DATA_TYPE_S32,     "",      "rw", 0, 65536,           NULL},
    {"userName",  &(runNetworkCfg.ftp.userName),  GK_CFG_DATA_TYPE_STRING,  "",    "rw", 1, MAX_STR_LEN_64,  NULL},
    {"password",  &(runNetworkCfg.ftp.password),  GK_CFG_DATA_TYPE_STRING,  "",    "rw", 1, MAX_STR_LEN_64,  NULL},
    {"datapath",  &(runNetworkCfg.ftp.datapath),  GK_CFG_DATA_TYPE_STRING,  "MDSnapshot",   "rw", 1, MAX_STR_LEN_128,  NULL},
    {"filename",  &(runNetworkCfg.ftp.filename),  GK_CFG_DATA_TYPE_STRING,  "image.jpg",   "rw", 1, MAX_STR_LEN_128,  NULL},
    {"interval",  &(runNetworkCfg.ftp.interval),  GK_CFG_DATA_TYPE_S32,     "30",   "rw", 1, MAX_STR_LEN_128,  NULL},
    {NULL,},
};

GK_CFG_MAP portMap[] = {
    {"httpPort", &(runNetworkCfg.port.httpPort), GK_CFG_DATA_TYPE_S32,  "80",   "rw", 0, 65536, NULL},
    {"rtspPort", &(runNetworkCfg.port.rtspPort), GK_CFG_DATA_TYPE_S32,  "554",  "rw", 0, 65536, NULL},
    {NULL,},
};

GK_CFG_MAP wifiLinkMap[] ={

	{"ssid",	  runNetworkCfg.wifilink[0].essid,GK_CFG_DATA_TYPE_STRING,  "",    "rw", 1, MAX_STR_LEN_32,  NULL},
	{"passd",	  runNetworkCfg.wifilink[0].passd,GK_CFG_DATA_TYPE_STRING,	"",    "rw", 1, MAX_STR_LEN_32,  NULL},
	{"encMode",   &runNetworkCfg.wifilink[0].encMode,GK_CFG_DATA_TYPE_S32,	"0",    "rw", 1, 88,  NULL},
	{NULL,}
};


GK_CFG_MAP wirelessMap[] ={
	{"enable",	  &runNetworkCfg.wireless.enable,GK_CFG_DATA_TYPE_S32,  "1",    "rw", 0, 1,  NULL},
	{"mode",	  &runNetworkCfg.wireless.mode,	GK_CFG_DATA_TYPE_S32,    "1",	  "rw", 0, 1,  NULL},
	{"apBssId",	  &runNetworkCfg.wireless.apBssId,GK_CFG_DATA_TYPE_S32, "0",	  "rw", 0, 1,  NULL},
	{"apPsk",     &runNetworkCfg.wireless.apPsk,GK_CFG_DATA_TYPE_S32, "0",   "rw", 0, 1,  NULL},
	{NULL,}
...
start_load:
    ...
    for(i = 0;  lanMap[i].stringName != NULL;i++)
    {
    	if(strcmp(lanMap[i].stringName,"mac") == 0)
    	{
            ...
            {
                if (strcmp(factory.device_id, "000000000") != 0)
                {
	...
	if(strlen(runNetworkCfg.wifilink[0].essid) == 0)
	{
		...
		if(!load_info_to_mtd_reserve(MTD_TUTK_P2P, &info, sizeof(struct device_info_mtd)) )
		{
			...
			{
				strncpy(runNetworkCfg.wifilink[0].essid, info.wifi_ssid,32);
				strncpy(runNetworkCfg.wifilink[0].passd, info.wifi_psd,32);
