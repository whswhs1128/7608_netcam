...
GK_CFG_MAP deviceInfoMap[] = {
    {"deviceName",        &(runSystemCfg.deviceInfo.deviceName),        GK_CFG_DATA_TYPE_STRING, "GKIPC",      "rw", 1, MAX_SYSTEM_STR_SIZE, NULL},
    {"description",       &(runSystemCfg.deviceInfo.manufacturer),      GK_CFG_DATA_TYPE_STRING, "GOKE",     "rw", 1, MAX_SYSTEM_STR_SIZE, NULL},
    {"deviceType",       &(runSystemCfg.deviceInfo.deviceType),         GK_CFG_DATA_TYPE_STRING, "IPC_A1",   "rw", 1, MAX_SYSTEM_STR_SIZE, NULL},
    {"sensorType",        &(runSystemCfg.deviceInfo.sensorType),        GK_CFG_DATA_TYPE_S32,    "0",        "rw", 0, 10, "0: IMX222; 1 OV9710 2 ..."},
    {"languageType",      &(runSystemCfg.deviceInfo.languageType),      GK_CFG_DATA_TYPE_S32,    "0",        "rw", 0, 18, "0: chiness; 1 english 2 japanese; 3 ..."},
    {"videoType",         &(runSystemCfg.deviceInfo.videoType),         GK_CFG_DATA_TYPE_S32,    "0",        "rw", 0, 1, "0 pal, 1 ntsc"},
    ...
    {"odmId",               &(runSystemCfg.deviceInfo.odmId),               GK_CFG_DATA_TYPE_S32,    "10",        "rw", 0, 30, "1: ds; 10: goke "},
    {"model",               &(runSystemCfg.deviceInfo.model),               GK_CFG_DATA_TYPE_STRING,  "GOKE_YTJ_AP_001",     "rw", 1, MAX_SYSTEM_STR_SIZE, NULL},
    {"devType",             &(runSystemCfg.deviceInfo.devType),             GK_CFG_DATA_TYPE_S32,    "1",        "rw", 0, 10, "0:kjp, 1:ytj, 2:allview,3:single door ring,4:dual door ring，5: 38 model"},

    {NULL,},
};

GK_CFG_MAP timezoneCfgMap[] = {
    {"timeZone", &(runSystemCfg.timezoneCfg.timezone), GK_CFG_DATA_TYPE_S32, "480", "rw", -720, 720,  NULL},
	{"timeZone_Desc", &(runSystemCfg.timezoneCfg.time_desc), GK_CFG_DATA_TYPE_STRING, "People's Republic of China", "rw", 1, 256,  NULL},
    {NULL,},
};

GK_CFG_MAP netDstCfgCfgMap[] = {
    {"netDstCfg.enableDST",  &(runSystemCfg.netDstCfg.enableDST),  GK_CFG_DATA_TYPE_S32,     "0",         "rw", 0, 1,  NULL},
    {"netDstCfg.dSTBias",    &(runSystemCfg.netDstCfg.dSTBias),    GK_CFG_DATA_TYPE_S32,     "0",         "rw", 0, 360,  NULL},
    {"netDstCfg.beginTime",  &(runSystemCfg.netDstCfg.beginTime),  GK_CFG_DATA_TYPE_STRING,  "2015.8.30", "rw", 1, MAX_TIME_STR_SIZE,  NULL},
    {"netDstCfg.endTime",    &(runSystemCfg.netDstCfg.endTime),    GK_CFG_DATA_TYPE_STRING,  "2015.8.30", "rw", 1, MAX_TIME_STR_SIZE,  NULL},
    {NULL,},
};

GK_CFG_MAP ntpCfgMap[] = {
    {"ntpCfg_enable",        &(runSystemCfg.ntpCfg.enable),        GK_CFG_DATA_TYPE_S32,     "1",               "rw", 0, 1,  NULL},
    {"ntpCfg_serverDomain",  &(runSystemCfg.ntpCfg.serverDomain),  GK_CFG_DATA_TYPE_STRING,  "time-a.nist.gov", "rw", 1, MAX_URL_STR_SIZE, NULL},
    {"ntpCfg_synctime",      &(runSystemCfg.ntpCfg.sync_time),     GK_CFG_DATA_TYPE_S32,     "43200",           "rw", 0, 100000,  NULL},
    {"ntpCfg_port",          &(runSystemCfg.ntpCfg.port),          GK_CFG_DATA_TYPE_S32,     "123",             "rw", 0, 65535,  NULL},
    {NULL,},
};


GK_CFG_MAP maintainCfgMap[] = {
    {"enable",   &(runSystemCfg.maintainCfg.enable),  GK_CFG_DATA_TYPE_U8,    "0",  "rw", 0, 1,  NULL},
    {"index",    &(runSystemCfg.maintainCfg.index),   GK_CFG_DATA_TYPE_U8,    "2",  "rw", 0, 7,  NULL},
    {"hour",     &(runSystemCfg.maintainCfg.hour),    GK_CFG_DATA_TYPE_U8,    "3",  "rw", 0, 23,   NULL},
    {"minute",   &(runSystemCfg.maintainCfg.minute),  GK_CFG_DATA_TYPE_U8,    "0",  "rw", 0, 59,   NULL},
    {"second",   &(runSystemCfg.maintainCfg.second),  GK_CFG_DATA_TYPE_U8,    "0",  "rw", 0, 59,   NULL},

    {"newest_time",   &(runSystemCfg.maintainCfg.newest_time),  GK_CFG_DATA_TYPE_S32,    "0",  "rw", 0, 2147483647,   NULL},

    {NULL,},
};
GK_CFG_MAP systemInfoMap[] = {
    {"device_name",        &(g_systemInfo.device_name),        GK_CFG_DATA_TYPE_STRING, "gkipc",      "rw", 1, MAX_SYSTEM_STR_SIZE, NULL},
    {"device_type",        &(g_systemInfo.device_type),        GK_CFG_DATA_TYPE_STRING, "ipc_a1",      "rw", 1, MAX_SYSTEM_STR_SIZE, NULL},
    {"chip_type",        &(g_systemInfo.chip_type),        GK_CFG_DATA_TYPE_STRING, "gk7101",      "rw", 1, MAX_SYSTEM_STR_SIZE, NULL},
    {"sensor_type",       &(g_systemInfo.sensor_type),     GK_CFG_DATA_TYPE_STRING, "ov2710_v10",     "rw", 1, MAX_SYSTEM_STR_SIZE, NULL},
    {"svn_version",       &(g_systemInfo.svn_version),     GK_CFG_DATA_TYPE_STRING, "1110",   "rw", 1, MAX_SYSTEM_STR_SIZE, NULL},
    {"make_date",        &(g_systemInfo.make_date),        GK_CFG_DATA_TYPE_STRING,    "0",        "rw", 0, MAX_SYSTEM_STR_SIZE, NULL},
    {NULL,},
};
...
char *SytemCfgGetCjsonString()
{
    ...
    cJSON_AddStringToObject(json, "deviceMAC", runNetworkCfg.lan.mac);
