...
GK_CFG_MAP audioMap[] = {
    ...
    {"chans",          &runAudioCfg.chans,          GK_CFG_DATA_TYPE_S32, "1",    "rw", 1, 2, "1, 2"},
    ...
    {"digitalGain",    &runAudioCfg.digitalGain,    GK_CFG_DATA_TYPE_U8,  "3",    "rw", 0, 100, NULL},
    {NULL,},   
};
...
GK_CFG_MAP audioMap[] = {
	...
	{"audioInEnable",  &runAudioCfg.audioInEnable,  GK_CFG_DATA_TYPE_U8,  "1",        1, 0, 2, NULL},
        ...
        {"digitalGain",    &runAudioCfg.digitalGain,    GK_CFG_DATA_TYPE_U8,  "3",    1, 0, 100, NULL},		//xqq
       	{NULL,},
};
...
{
	PRINT_ERR("AudioCfgLoadDefValue!\n");
