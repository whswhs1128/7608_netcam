...
** \file      $gkprjh265.c
**
** \version	$id: h265.c 15-08-04  8月:08:1438655117 
**
** \brief       
**
...
typedef struct es_format_t
{
    ...
    int      i_profile;       /**< codec specific information (like real audio flavor, mpeg audio layer, h265 profile ...) */
