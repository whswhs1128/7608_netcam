...
#if LV_MEM_CUSTOM == 0
#define LV_MEM_SIZE    (400U * 1024U)        /*Size memory used by `lv_mem_alloc` in bytes (>= 2kB)*/
...
#define LV_HOR_RES          (480)   //水平
#define LV_VER_RES          (800)   //垂直
//#define LV_HOR_RES          (300)   //水平
//#define LV_VER_RES          (160)   //垂直
#define LV_DPI                   40

#define HM_LINE_H               44

#define LV_WIN_TITLE_H    47 /*win title height*/
...
/*Color settings*/
#define LV_COLOR_DEPTH     16                     /*Color depth: 1/8/16/24/4444*/
...
//#define LV_FONT_TITLE             &lv_font_dejavu_30     /*Always set a default font from the built-in fonts*/
//#define LV_FONT_BOLD             &lv_font_dejavu_40     /*Always set a default font from the built-in fonts*/
#define LV_FONT_TITLE             &lv_font_dejavu_20     /*Always set a default font from the built-in fonts*/
#define LV_FONT_BOLD             &lv_font_dejavu_20     /*Always set a default font from the built-in fonts*/
