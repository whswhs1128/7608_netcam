...
struct __HTTP_OPS
{
	...
	*/
	...
	/**
		get query string /int:  ??¨¨?http¦Ì?2¨¦?¡¥2?¨ºy
		ops:       http 2¨´¡Á¡Â?¡¥????
		name:                 2?¨ºy??¡Á?
		return:                2¨¦?¡¥2?¨ºy¦Ì??¦Ì
	*/
	...
	/**
		get fragment      :   ??¨¨?2¨¦?¡¥2?¨ºy#o¨®??¦Ì?¡Á?¡¤?¡ä?¨¨?:
		                             appid=549000912&e=2&l=M&s=3#xxx
		ops:       http 2¨´¡Á¡Â?¡¥????
		return                :   xxx
	*/
...
#define HPE_RET_DISCONNECT                 1      //cgi¡¤¡é?¨ªraw¡ã¨¹¨º¡À¨º1¨®?¡ä?¡¤¦Ì???¦Ì
