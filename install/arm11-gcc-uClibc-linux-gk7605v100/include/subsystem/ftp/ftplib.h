...
#define ftpConnect(x) FtpConnect(x, &DefaultNetbuf)
...
#define ftpExists(x, y) FtpExists(x, y,DefaultNetbuf)
...
GLOBALDEF int Getftpfilesize(void);//自定义
