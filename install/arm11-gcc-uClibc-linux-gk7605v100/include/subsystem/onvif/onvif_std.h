...
/* OSD */
#define MAX_OSD_PositionOption_NUM      3
#define MAX_OSD_DateFormat_NUM          6
#define MAX_OSD_Type_NUM                4
#define MAX_OSD_TimeFormat_NUM          2
...
#if ONVIF_DEBUG
#define ONVIF_DBG(format, ...) printf("\033[0;0m[ONVIF DBG| "__FILE__":%d] "format"\033[0;0m\n", __LINE__, ##__VA_ARGS__)
#else
#define ONVIF_DBG(format, ...)
#endif

#if ONVIF_INFOR
#define ONVIF_INFO(format, ...) printf("\033[0;36m[ONVIF INFOR| "__FILE__":%d] "format"\033[0;0m\n", __LINE__, ##__VA_ARGS__)
#else
#define ONVIF_INFO(format, ...)
#endif

#if ONVIF_ERROR
#define ONVIF_ERR(format, ...) printf("\033[0;31m[ONVIF ERR| "__FILE__":%d] "format"\033[0;0m\n", __LINE__, ##__VA_ARGS__)
#else
