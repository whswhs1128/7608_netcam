...
{
    GK_CHAR aszXAddr[MAX_ADDR_LENGTH];
    GONVIF_Boolean_E IOInputSupport;
    GONVIF_Boolean_E PrivacyMaskSupport;
    GONVIF_Boolean_E PTZ3DZoomSupport;
    GONVIF_Boolean_E PTZPatternSupport;
    GK_S32 Language;
}GONVIF_DEVMNG_hikCapabilities_S;


typedef struct
{
    GONVIF_DEVMNG_hikCapabilities_S stHik;
...
typedef struct 
{
    ...
    GONVIF_DEVMNG_GetCapabilities pfnDM_GetCapabilities;                    
    ...
    GONVIF_DEVMNG_GetNetworkInterfaces pfnDM_GetNetworkInterfaces;          
    ...
    GONVIF_DEVMNG_GetDeviceInformation pfnDM_GetDeviceInformation;          
    ...
    GONVIF_DEVMNG_GetScopes pfnDM_GetScopes;                                
