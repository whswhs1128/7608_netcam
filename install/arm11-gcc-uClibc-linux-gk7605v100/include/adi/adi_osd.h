...
/*!
*******************************************************************************
** \brief get area parameters of osd plane.
**
** \param[in]  handle     Valid ADI osd instance handle previously opened by
**                        #gadi_osd_open.
...
/*!
*******************************************************************************
** \brief loads the RGB bitmap in the specified format into the OSD ,and OSD parameters can be configured at load time.
**
** \param[in]  handle     Valid ADI osd instance handle previously opened by
**                        #gadi_osd_open.
** \param[in/out] areaParams  pointer of area parameters struct, must give out
**                            plane id & area id.
**\param[in/out] bitMapAttr  pointer of bitmap parameters struct
**
** \return
** - #GADI_OK
** - #GADI_OSD_ERR_FROM_DRIVER
...
/*!
*******************************************************************************
** \brief set channel parameters of osd plane.
**
** \param[in]  handle     Valid ADI osd instance handle previously opened by
**                        #gadi_osd_open.
**\param[in]  areaIndex  area index
** \param[in/out] chnAttr  pointer of channel parameters struct
**
** \return
** - #GADI_OK
** - #GADI_OSD_ERR_FROM_DRIVER
...
/*!
*******************************************************************************
** \brief get channel parameters of osd plane.
**
** \param[in]  handle     Valid ADI osd instance handle previously opened by
**                        #gadi_osd_open.
**\param[in]  areaIndex  area index
