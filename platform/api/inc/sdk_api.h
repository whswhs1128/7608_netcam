...
#define SDK_MAX_VIN_NUM (1)

#ifndef SDK_API_H_
#define SDK_API_H_

#define SDK_ALIGNED_LITTLE_ENDIAN(__val, __align) ((__val) & ~((__align)-1u))
#define SDK_ALIGNED_BIG_ENDIAN(__val, __align) SDK_ALIGNED_LITTLE_ENDIAN((__val) + (__align) - 1, (__align))
