/*!
*****************************************************************************
** \file        c2390_reg_tbl.c
**
** \version     $Id: c2390_reg_tbl.c 11449 2017-02-10 03:09:18Z yulindeng $
**
** \brief
**
...
*****************************************************************************
*/
GADI_VI_SensorDrvInfoT    c2390_sensor =
{
    ...
    .field_format       = 1,
    .adapter_id         = 0,
    .sensor_id          = GADI_ISP_SENSOR_C2390,
    ...
    .video_fmt_table =
    {
        // 1080P C2390_HMAX = SD(44 + 148 - 4 - 16 - 24 - 8 = 140) + Sync(4) + OB(16) + Ignored(24) + Effective(8) + x + Effective(8) + Ignored(24) + Sync(4) + HB(52)
        // 1080P C2390_VMAX = Dummy(6) + FI(1) + OB(4) + VDE OB(8) + Ignored(4) + Effective(8) + y + Effective(9) + Ignored(4) + VB(1)
        // 720P  C2390_HMAX = SD(40 + 220 - 4 - 16 - 24 - 8 = 208) + Sync(4) + OB(16) + Ignored(24) + Effective(8) + x + Effective(8) + Ignored(24) + Sync(4) + HB
        // 720P  C2390_VMAX = Dummy(6) + FI(1) + OB(4) + VDE OB(6) + Ignored(2) + Effective(4) + y + Effective(5) + Ignored(2)
        ...
        [1] = // 1920x1080P@25fps   (5280 / 2) * 1125 * 25 = 74250000
        {
            ...
            {
                {0x0100, 0x00, 0x01}, // BIT[0]MODE_SEL 0:STANDBY, 1: Normal operation
                {0x0342, 0x14}, // HMAX_MSB    5280 = 0x14A0
...
#define C2390_H_MIRROR     (1<<0)
#define C2390_V_FLIP       (1<<1)
    .mirror_table =
    {
        [GADI_VI_SRC_MIRROR_HORRIZONTALLY_VERTICALLY] =
        {
            {0x0101, C2390_H_MIRROR | C2390_V_FLIP, C2390_H_MIRROR | C2390_V_FLIP},
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
        [GADI_VI_SRC_MIRROR_HORRIZONTALLY] =
        {
            {0x0101, C2390_H_MIRROR, C2390_H_MIRROR | C2390_V_FLIP},
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
        [GADI_VI_SRC_MIRROR_VERTICALLY] =
        {
            {0x0101, C2390_V_FLIP, C2390_H_MIRROR | C2390_V_FLIP},
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
        [GADI_VI_SRC_MIRROR_NONE] =
        {
            {0x0101, 0x00, C2390_H_MIRROR | C2390_V_FLIP},
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
    },
    .version_reg =
