/*!
*****************************************************************************
** \file        c1490_reg_tbl.c
**
** \version     $Id: c1490_reg_tbl.c 11449 2017-02-10 03:09:18Z yulindeng $
**
** \brief
**
...
*****************************************************************************
*/
GADI_VI_SensorDrvInfoT    c1490_sensor =
{
    ...
    .field_format       = 1,
    .adapter_id         = 0,
    .sensor_id          = GADI_ISP_SENSOR_C1490,
    ...
    .init_reg           =
    {
        {0x3E03, 0x03}, // C1490_AEC_ENABLE
        {0x3E01, 0x2E}, // C1490_AEC_EXP_TIME_H
        {0x3E09, 0x00}, // C1490_AEC_GAIN_L
        {0x3E0F, 0x84}, // C1490_AEC_3E0F
        //{0x3907, 0x03}, // C1490_BLC_TARGET_H
        {0x3907, 0x00},
        ...
        {0x3630, 0x88},
        {0x3635, 0x80},
        {0x3415, 0x00}, // C1490_RNC_TARGET_H
        {0x3416, 0x40}, // C1490_RNC_TARGET_L
        {0x3310, 0x83},
        {0x3336, 0x00},
        {0x3337, 0x00},
        {0x3338, 0x02},
    ...
    .pll_table =
    {
        ...
        [0] =
        {
            ...
            .regs =
            {
                {0x3010, 0x01}, // C1490_PLL_PRE_CLK_DIV 0 000 000 1 SYSEL[2:0] = b000, PreDIV[2:0] = b000 1x,PLLDIV[5] = b1
                {0x3011, 0x86}, // C1490_PLL_SYS_CLK_DIV 10000 110 PLLDIV[4:0] = b10000
                {0x3004, 0x45}, // C1490_SCLK_DIV[3:0]
        ...
        [1] =
        {
            ...
            .regs =
            {
                {0x3010, 0x11}, // C1490_PLL_PRE_CLK_DIV 0 001 000 1 SYSEL[2:0] = b001, PreDIV[2:0] = b000 1x,PLLDIV[5] = b1
                {0x3011, 0x56}, // C1490_PLL_SYS_CLK_DIV 01010 110 PLLDIV[4:0] = b01010
                {0x3004, 0x44}, // C1490_SCLK_DIV[3:0]
                {GADI_VI_SENSOR_TABLE_FLAG_MDELAY, 0x02},// mdelay(2);
                {GADI_VI_SENSOR_TABLE_FLAG_END,},
            }
        },
        ...
        [3] =
        {
            ...
            .regs =
            {
                {0x3010, 0x31}, // C1490_PLL_PRE_CLK_DIV 0 011 000 1 SYSEL[2:0] = b011, PreDIV[2:0] = b000 1x,PLLDIV[5] = b1
                {0x3011, 0x56}, // C1490_PLL_SYS_CLK_DIV 01010 110 PLLDIV[4:0] = b01010
                {0x3004, 0x44}, // C1490_SCLK_DIV[3:0]
                {GADI_VI_SENSOR_TABLE_FLAG_MDELAY, 0x02},// mdelay(2);
                {GADI_VI_SENSOR_TABLE_FLAG_END,},
    ...
    .video_fmt_table =
    {
        [0] = // 1280x720P@60fps    1920 * 750 * 60 = 86400000
        {
            ...
            .fmt_reg =
            {
                {0x3208, 0x05,}, // C1490_TIMING_X_SIZE_H  1280 = 0x0500
                {0x3209, 0x00,}, // C1490_TIMING_X_SIZE_L
                {0x320A, 0x02,}, // C1490_TIMING_Y_SIZE_H   720 = 0x02D0
                {0x320B, 0xD0,}, // C1490_TIMING_Y_SIZE_L
                {0x320C, 0x07,}, // C1490_TIMING_HTS_H     1920 = 0x0780
                {0x320D, 0x80,}, // C1490_TIMING_HTS_L
                {0x320E, 0x02,}, // C1490_TIMING_VTS_H      750 = 0x02EE
                {0x320F, 0xEE,}, // C1490_TIMING_VTS_L
                {0x3210, 0x00,}, // C1490_TIMING_HOFFS_H
                {0x3211, 0x57,}, // C1490_TIMING_HOFFS_L
                {0x3212, 0x00,}, // C1490_TIMING_VOFFS_H
                {0x3213, 0x0E,}, // C1490_TIMING_VOFFS_L
                {0x3338, 0x02,},
                {0x3339, 0xEE,},
                {0x3336, 0x00,},
                {0x3337, 0x00,},
        ...
        [1] = // 1280x720P@50fps    1980 * 750 * 50 = 74250000
        {
            ...
            .fmt_reg =
            {
                ...
                {0x320A, 0x02,}, // C1490_TIMING_Y_SIZE_H   720 = 0x02D0
                {0x320B, 0xD0,}, // C1490_TIMING_Y_SIZE_L
                {0x320C, 0x07,}, // C1490_TIMING_HTS_H     1980 = 0x07BC
                {0x320D, 0xBC,}, // C1490_TIMING_HTS_L
                {0x320E, 0x02,}, // C1490_TIMING_VTS_H      750 = 0x02EE
                {0x320F, 0xEE,}, // C1490_TIMING_VTS_L
                {0x3210, 0x00,}, // C1490_TIMING_HOFFS_H
                {0x3211, 0x57,}, // C1490_TIMING_HOFFS_L
    ...
    .mirror_table =
    {
#define C1490_FLIP                 0x40
#define C1490_MIRROR               0x01
        [GADI_VI_SRC_MIRROR_HORRIZONTALLY_VERTICALLY] =
        {
            {0x3781, 0x08},
            {0x3211, 0x11},
            {0x321C, C1490_FLIP, C1490_FLIP},     // C1490_FLIP
            {0x321D, C1490_MIRROR, C1490_MIRROR}, // C1490_MIRROR
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
        [GADI_VI_SRC_MIRROR_HORRIZONTALLY] =
        {
            {0x3781, 0x08},
            {0x3211, 0x11},
            {0x321C, 0x00, C1490_FLIP},            // C1490_FLIP
            {0x321D, C1490_MIRROR, C1490_MIRROR}, // C1490_MIRROR
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
        [GADI_VI_SRC_MIRROR_VERTICALLY] =
        {
            ...
            {0x3211, 0x61},
            {0x321C, C1490_FLIP, C1490_FLIP},     // C1490_FLIP
            {0x321D, 0x00, C1490_MIRROR},          // C1490_MIRROR
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
    ...
    // hmax = (C1490_TIMING_HTS_H & 0xFF) << 8 +
    //        (C1490_TIMING_HTS_L & 0xFF) << 0
    .hmax_reg =
    {
        {0x320C, 0x00, 0xFF, 0x00, 0x08, 0}, // C1490_TIMING_HTS_H
        {0x320D, 0x00, 0xFF, 0x00, 0x00, 0}, // C1490_TIMING_HTS_L
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    // vmax = (C1490_TIMING_VTS_H & 0xFF) << 8 +
    //        (C1490_TIMING_VTS_L & 0xFF) << 0
    .vmax_reg =
    {
        {0x320E, 0x00, 0xFF, 0x00, 0x08, 0}, // C1490_TIMING_VTS_H
        {0x320F, 0x00, 0xFF, 0x00, 0x00, 0}, // C1490_TIMING_VTS_L
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    ...
    // shs = (C1490_AEC_EXP_TIME_H & 0xFF) << 4 +
    //       (C1490_AEC_EXP_TIME_L & 0xF0) >> 4
    .shs_reg =
    {
        {0x3E01, 0x00, 0xFF, 0x00, 0x04, 0}, // C1490_AEC_EXP_TIME_H
        {0x3E02, 0x00, 0xF0, 0x01, 0x04, 0}, // C1490_AEC_EXP_TIME_L
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
