...
GADI_VI_SensorDrvInfoT    gc2053_sensor_mipi =
{
    ...
    {        
        ...
        {0x8c,  0x12},
        {0x8d,  0x92},
        {0x90,  0x00},  //0x00: frame length can active fps.
        {0x9d,  0x10},
        {0xce,  0x7c},
        {0xd2,  0x41},
        {0xd3,  0xdc},
        ...
        {0xfe,  0x00},
        {0x3e,  0x91}, 
        {GADI_VI_SENSOR_TABLE_FLAG_MDELAY, 50},
    ...
    .video_fmt_table =
    {
        ...
        [1] = // 1280x720@50fps   (900 * 2) * 937.5 * 50 = 84375000
        {     // 1280x720@60fps   (900 * 2) * 781.25 * 60= 84375000                   
            ...
            .vi_info =
            {
                ...
                .dgain_type = GADI_ISP_TUNNING_DATA_AE_SHT_DGAIN_1080P_25,//GADI_ISP_TUNNING_DATA_AE_SHT_DGAIN_720P_60,
            },
            .video_info_table =
            {
                .def_start_x    = 0,
