/*!
*****************************************************************************
** \file        sc4236_reg_tbl.c
**
** \version     $Id: sc4236_reg_tbl.c 11807 2017-04-13 09:38:45Z hehuali $
**
** \brief
**
...
GADI_VI_SensorDrvInfoT    sc4236_sensor_mipi =
{
...
/*        
        [2] = // 1920x1080P@30fps   3900 * 1500 * 20 = 117000000
        {
            .video_mode_table =
            {
        ...
        [3] = // 2304x1296P@20fps   3900 * 1500 * 15 = 117000000
        {
            .video_mode_table =
            {
                .mode = GADI_VIDEO_MODE(2304, 1296,  15, 1),
                .preview_mode_type = GADI_VI_SRC_ENABLED_FOR_VIDEO | GADI_VI_SRC_ENABLED_FOR_STILL,
                .still_mode_type   = GADI_VI_SRC_ENABLED_FOR_VIDEO | GADI_VI_SRC_ENABLED_FOR_STILL,
            },
            .fmt_reg =
