...
#if CONFIG_SYSTEM_VOUT == 1     //I80 8bit(undefined)
#define SYSTEM_GPIO_SDCARD_TABLE        \
...
#elif CONFIG_SYSTEM_VOUT == 4   //RGB 8bit with SPI0(undefined)
#define SYSTEM_GPIO_XREF_TABLE


#elif CONFIG_SYSTEM_VOUT == 5   //RGB 8bit with SPI1(undefined)
#define SYSTEM_GPIO_XREF_TABLE
